...
public class OpenApiVo { // 사실상 vo보단 dto가 어울림
	// 이 밑 자료보다 url로 들어가서 F12가 더 정확
...
//	초미세먼지(PM2.5) 플래그	pm25Flag	10	필수	점검및교정	측정자료 상태정보(점검및교정, 장비점검, 자료이상, 통신장애)
	...
	public OpenApiVo(String stationName, String dateTime, String pm10Value, String so2Value, String so2Grade) {
		super();
	...
	public String toString() {
		return "OpenApiVo [stationName=" + stationName + ", dateTime=" + dateTime + ", pm10Value=" + pm10Value
